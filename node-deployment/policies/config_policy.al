...
<set policy new_policy [config][script] = [
    ...
    "if !system_query == true and !enable_mcp == true then run mcp server",
    "if !enable_aggregations == true then process !local_scripts/deployment-scripts/sample-scripts/aggregation.al",
    "if !enable_mqtt == true then process !local_scripts/deployment-scripts/sample-scripts/basic_msg_client.al",
    "if !enable_video_streaming == true then process !local_scripts/deployment-scripts/southbound-video-streaming/video_ai.al",
    "process !local_scripts/deployment-scripts/southbound-monitoring/deploy_monitoring.al",
    "if !deploy_local_script == true then process !local_scripts/node-deployment/local_script.al",
    "if !is_edgelake == false then process !local_scripts/node-deployment/policies/license_policy.al"
]>
