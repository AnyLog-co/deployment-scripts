...
#----------------------------------------------------------------------------------------------------------------------#
# process !local_scripts/sample-scripts/notifications/smart_city_sensor_state.al
# schedule name = [service name] and time = 15 minutes and task process !local_scripts/sample-scripts/notifications/smart_city_sensor_state.al
